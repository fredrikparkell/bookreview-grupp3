...
namespace BookReviewGrupp4.Data
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void CreateBooks(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().HasData(new Book { BookId = 6, Name = "How to get every trophy in every game that has ever existed", Genre = "Games", Published = new DateTime(2015, 10, 18), Description = "I'll guide you on how to get all the trophies in every game. Only for gamers so this book only supports Playstation players", AuthorId = 6 });
